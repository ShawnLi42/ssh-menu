...
- `demo.gif` — real WSL recording of ssh_menu: arrow-key nav (preview follows) + live filtering
...
- `05-tab-severity.png` — per-environment tab colors (severity at a glance)
